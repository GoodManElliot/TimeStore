...
package com.example.clusterutil.clustering.view;
...
import com.example.clusterutil.MarkerManager;
import com.example.clusterutil.clustering.Cluster;
import com.example.clusterutil.clustering.ClusterItem;
import com.example.clusterutil.clustering.ClusterManager;
import com.example.clusterutil.projection.Point;
import com.example.clusterutil.projection.SphericalMercatorProjection;
import com.example.clusterutil.ui.IconGenerator;
...
import static com.example.clusterutil.clustering.algo.NonHierarchicalDistanceBasedAlgorithm.MAX_DISTANCE_AT_ZOOM;
...
public class DefaultClusterRenderer<T extends ClusterItem> implements
        com.example.clusterutil.clustering.view.ClusterRenderer<T> {
    ...
    private com.example.clusterutil.ui.SquareTextView makeSquareTextView(Context context) {
        com.example.clusterutil.ui.SquareTextView squareTextView =
                new com.example.clusterutil.ui.SquareTextView(context);
